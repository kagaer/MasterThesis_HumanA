...
if experiment == 1:
    ...
    savepath = savepath + "Exp1/Dec_Expl_Matrix/"
...
def addVisitToStrategyMatrix(node,decisions):
...
for participant in participants:
    ...
    for session in sessions:
        ...
        for datapoint in data:
            ...
            if last_node != []:
                ...
                addVisitToStrategyMatrix(node,decisions)
                adjustVisits(node)
    ...
    plotTotal(strategy_matrix_participant_total,count_dec_seeking_part,count_dec_avoiding_part,participant,sessions, save_path = savepath)
    plotSession(strategy_matrix_participant_perSession,count_dec_seeking_ses,count_dec_avoiding_ses,participant,sessions,save_path = savepath )
    
plotTotal(strategy_matrix_total,count_dec_seeking_total,count_dec_avoiding_total, participants = participants,save_path = savepath)
plotSession(strategy_matrix_perSession,count_dec_seeking_total_ses,count_dec_avoiding_total_ses, participants = participants,save_path = savepath)
